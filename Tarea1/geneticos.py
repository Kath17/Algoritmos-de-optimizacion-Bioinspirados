...
def Entradas():
    ...
    return poblacion,cromosomas,iteraciones,punto,prob_mut
...
def Cruzamiento(ListaBin,pos,Madre,Padre,prob):
    Mom = ListaBin[Madre]
    Dad = ListaBin[Padre]
    print("\nMadre: ",Mom)
    f.write("\nMadre: "+str(Mom)+"\n")
...
# ------------------------Proceso completo -------------------------#
def Main():
    poblacion,cromosomas,iteraciones,punto,prob_mut = Entradas()
    ...
    for i in range(iteraciones):
        ...
        for i in range (nro_cruzamientos):
            ...
            print("Madre: ",Madre)
            print("Padre: ",Padre)
            Hijo1,Hijo2=Cruzamiento(ListaBin,punto,Madre,Padre,prob_mut)
            print("Hijo 1: ",Hijo1)
            print("Hijo 2: ",Hijo2)
