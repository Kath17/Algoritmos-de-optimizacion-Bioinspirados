...
def HallarNuevasFeromonas(MatrizFeromona,ListaHormigas,evaporacion,Q):
        ...
        for j in range(len(Ciudades)):
            ...
            for k in range(len(ListaHormigas)):
                if(i!=j):
                    ...
                    MatrizFeromona[Ciudades[i]][Ciudades[j]] = 0
...
def Main():
    ...
    for i in range(iteraciones):
        ...
        MatrizFeromona = HallarNuevasFeromonas(MatrizFeromona,Lista,evaporacion,Q)
